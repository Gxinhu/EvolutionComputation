...
public class cec2005F3 extends Problem {
	 ...
	 */
	public cec2005F3(String solutionType, Integer numberOfVariables) throws ClassNotFoundException {
		numberOfVariables_ = numberOfVariables;
		numberOfObjectives_ = 1;
		numberOfConstraints_ = 0;
		problemName_ = "F03_shifted_rotated_high_cond_elliptic";
	...
	public void evaluate(Solution solution) throws JMException {
		...
		test_func aTestFunc = theBenchmark.testFunctionFactory(3, numberOfVariables_);
