...
import jmetal.experiments.settings.RVEASettting;
...
public class theBigWhaleStudy extends Experiment {
...
//				}
			...
			algorithm[2] = new r2psoSetting(problemName, problemParams).configure(parameters[0]);
	...
	public static void main(String[] args) throws JMException, IOException {
		theBigWhaleStudy exp = new theBigWhaleStudy();

		exp.experimentName_ = "TheBigWhaleStudy";

		exp.noOfObjectives_ = 5;
