...
import jmetal.experiments.settings.NSGAIIISetting;
import jmetal.experiments.settings.moeaddSetting;
...
public class moeaddAndNsgaIIIstudy extends Experiment {
...
//			algorithm[1] = new NSGAIISettings(problemName, problemParams).configure(parameters[0]);
	...
	public static void main(String[] args) throws JMException, IOException {
		...
		moeaddAndNsgaIIIstudy exp = new moeaddAndNsgaIIIstudy();
		exp.experimentName_ = "moeaddandnsgaIIIStudy";
		// 0 means only run the experiments 1 not run just generate the latex 2 both
		int generateTheResult = 2;
		exp.noOfObjectives_ = 8;
