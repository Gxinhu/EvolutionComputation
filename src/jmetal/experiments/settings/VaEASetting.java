...
import jmetal.metaheuristics.vamaea.VaEA;
 ...
 */
public class VaEASetting extends Settings {
	...
	public VaEASetting(String problem, int populationSize_, int maxGenerations, Object[] params) {
		super(problem);
		try {
