...
public class SPEA2_time {
	 ...
	 *                           ParetoFrontFile
	 */
	public static void printtime(String path, long[] GD) {
		try {
			/* Open the file */
	...
	public static void main(String[] args) throws JMException, IOException,
		...
		for (int fun = 1; fun <= 5; fun++) {
			...
			for (int i = 0; i < runtimes; i++) {
				...
				Execution_time[i] = (System.currentTimeMillis() - initTime);
	...
	if (indicators != null) {
		...
		logger_.info("Epsilon    : " + indicators.getEpsilon(population));
			...
			printtime("FUN" + fun + "time-SPEA2", Execution_time);
