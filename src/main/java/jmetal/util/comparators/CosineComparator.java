...
public class CosineComparator implements Comparator {
	 ...
	 */
	public CosineComparator(int nObj) {
		this.nObj = nObj;
		ascendingOrder_ = true;
	} // ObjectiveComparator

	public CosineComparator(int nObj, boolean descendingOrder) {
		this.nObj = nObj;
	...
	public int compare(Object o1, Object o2) {
		...
		double cosine1 = ((Solution) o1).getCosine(this.nObj);
		double cosine2 = ((Solution) o2).getCosine(this.nObj);
		if (ascendingOrder_) {
			if (cosine1 < cosine2) {
				return -1;
