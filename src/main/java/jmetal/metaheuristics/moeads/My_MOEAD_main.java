...
package jmetal.metaheuristics.moeads;
...
public class My_MOEAD_main {
	...
	/**
	 * @param GD Command line arguments. The first (optional) argument
	...
	public static void main(String[] args) throws JMException,
		...
		for (int fun = 1; fun <= 1; fun++) {
			...
			for (int i = 0; i < runtimes; i++) {
				...
				algorithm.setInputParameter("dataDirectory", "/home/hu/IdeaProjects/Nmpso/weight/W2D_100.dat");
