	...
	public Problem getProblem() throws ClassNotFoundException {
		...
		if (fun >= 13 & fun <= 21) {
			switch (fun) {
				...
				case 14: {
					problem = new WFG2("Real", k, 10, objectives);
					break;
				}//problem = new WFG1("Real");
				case 15: {
					problem = new WFG3("Real", k, 10, objectives);
					break;
				}
				case 16: {
					problem = new WFG4("Real", k, 10, objectives);
					break;
				}//problem = new WFG1("Real");
				case 17: {
					problem = new WFG5("Real", k, 10, objectives);
					break;
				}
				case 18: {
					problem = new WFG6("Real", k, 10, objectives);
					break;
				}//problem = new WFG1("Real");
				case 19: {
					problem = new WFG7("Real", k, 10, objectives);
					break;
				}//problem = new WFG1("Real");
				case 20: {
					problem = new WFG8("Real", k, 10, objectives);
					break;
				}
				case 21: {
					problem = new WFG9("Real", k, 10, objectives);
					break;
				}
				default:
					System.exit(0);
