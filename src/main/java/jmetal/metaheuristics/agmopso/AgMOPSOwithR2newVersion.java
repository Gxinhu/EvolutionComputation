...
public class AgMOPSOwithR2newVersion extends Algorithm {
...
//	private Solution pbest_[];// _[];
	...
	public AgMOPSOwithR2newVersion(Problem problem) {
		super(problem);
...
//				Scatter2d plott = new Scatter2d("X", "Y", problem.getName(), "0", data);
//				plott.plot();
//			} else {
//				Scatter3d plott = new Scatter3d("X", "Y", problem.getName(), "lambdaVector", data);
//				plott.plot();
//			}
//		    data = temp.writeObjectivesToMatrix();
////		double[][] data=lambdaVectors;
//			if (problem.getNumberOfObjectives() == 2) {
//				Scatter2d plott = new Scatter2d("X", "Y", problem.getName(), "1", data);
//				plott.plot();
//			} else {
//				Scatter3d plott = new Scatter3d("X", "Y", problem.getName(), "lambdaVector", data);
//				plott.plot();
