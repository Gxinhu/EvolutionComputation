 ...
 * @author hu
 */
public class VagPsoAdaptivelbestNoAdd extends Algorithm {
	...
	public VagPsoAdaptivelbestNoAdd(Problem problem) {
		super(problem);
	...
	private void eliminate(SolutionSet union) {
		...
		int remain = (int) (populationSize) - archive.size();
...
//				}// IF
	...
	private void offspringcreationbypso() throws JMException {
		...
		calculateDistanceToZmin(archive, new Array2DRowRealMatrix(functionValueMatrix));
		...
		calculateDistanceToZmin(population, populationValuesMatrix);
