...
public class VagPso_changepbestanddeletezmin extends Algorithm {
	...
	public VagPso_changepbestanddeletezmin(Problem problem) {
		super(problem);
...
//				}// IF
		...
		double[] minAngleArray = new double[removePopulation.size()];
