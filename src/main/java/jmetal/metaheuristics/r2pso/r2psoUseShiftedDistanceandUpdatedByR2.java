...
import jmetal.core.*;
import jmetal.metaheuristics.r2pso.util.BFEFitnessAssigment;
...
public class r2psoUseShiftedDistanceandUpdatedByR2 extends Algorithm {
	...
	private Distance diatance;
	private BFEFitnessAssigment bfeFitnessAssigment;

	public r2psoUseShiftedDistanceandUpdatedByR2(Problem problem, QualityIndicator indicator) {
		super(problem);
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		fMin = 0.25;
		degree = new Degree();
		bfeFitnessAssigment = new BFEFitnessAssigment(problem.getNumberOfObjectives());
