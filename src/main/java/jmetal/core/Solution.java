...
public class Solution implements Serializable {
    ...
    public Solution() {
        ...
        distanceToIdealPoint = 0.0;
        distanceToReferencePoint = 0.0;
        info_ = new double[3];
    ...
    public Solution(Solution solution) {
        ...
        ID = solution.getID();
        swarmIndex = solution.getSwarmIndex();
        distanceToReferencePoint = solution.distanceToReferencePoint;
    ...
    public void setDecisionVariable(double variable, int index) throws JMException {
        variable_[index].setValue(variable);
    } // setDecisionVariables
...
// Solution
    ...
    public void setSwarmIndex(int swarmIndex) {
    ...
    public double getNormalizedObjective(int index) {
        return normalizedObjective_[index];
    }

    public void setNormalizedObjective(int index, double value) {
        this.normalizedObjective_[index] = value;
    }
}
