...
import jmetal.metaheuristics.Vapso.SDE_PSO_Angle_changePbest_DTLZBetter;
 ...
 */
public class r2psoSBXSetting extends Settings {
	...
	public r2psoSBXSetting(String problem, Object[] params) {
		super(problem);
		try {
