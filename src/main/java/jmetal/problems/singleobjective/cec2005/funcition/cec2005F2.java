...
public class cec2005F2 extends Problem {
	 ...
	 */
	public cec2005F2(String solutionType, Integer numberOfVariables) throws ClassNotFoundException {
		numberOfVariables_ = numberOfVariables;
		numberOfObjectives_ = 1;
		numberOfConstraints_ = 0;
		problemName_ = "F02_shifted_schwefel";
	...
	public void evaluate(Solution solution) throws JMException {
		...
		test_func aTestFunc = theBenchmark.testFunctionFactory(2, numberOfVariables_);
