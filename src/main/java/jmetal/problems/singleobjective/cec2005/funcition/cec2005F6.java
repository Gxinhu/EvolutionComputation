...
public class cec2005F6 extends Problem {
	 ...
	 */
	public cec2005F6(String solutionType, Integer numberOfVariables) throws ClassNotFoundException {
		numberOfVariables_ = numberOfVariables;
		numberOfObjectives_ = 1;
		numberOfConstraints_ = 0;
		problemName_ = "F06_shifted_rosenbrock";
	...
	public void evaluate(Solution solution) throws JMException {
		...
		test_func aTestFunc = theBenchmark.testFunctionFactory(6, numberOfVariables_);
