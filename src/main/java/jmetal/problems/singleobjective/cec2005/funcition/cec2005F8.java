...
public class cec2005F8 extends Problem {
	 ...
	 */
	public cec2005F8(String solutionType, Integer numberOfVariables) throws ClassNotFoundException {
		numberOfVariables_ = numberOfVariables;
		numberOfObjectives_ = 1;
		numberOfConstraints_ = 0;
		problemName_ = "F08_shifted_rotated_ackley_global_opt_bound";
	...
	public void evaluate(Solution solution) throws JMException {
		...
		test_func aTestFunc = theBenchmark.testFunctionFactory(8, numberOfVariables_);
