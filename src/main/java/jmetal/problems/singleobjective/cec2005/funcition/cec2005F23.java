...
public class cec2005F23 extends Problem {
	 ...
	 */
	public cec2005F23(String solutionType, Integer numberOfVariables) throws ClassNotFoundException {
		numberOfVariables_ = numberOfVariables;
		numberOfObjectives_ = 1;
		numberOfConstraints_ = 0;
		problemName_ = "F23_noncontinuous_rotated_hybrid_composition_3";
	...
	public void evaluate(Solution solution) throws JMException {
		...
		test_func aTestFunc = theBenchmark.testFunctionFactory(23, numberOfVariables_);
