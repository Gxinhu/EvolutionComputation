 ...
 */
public class DTLZ5IM extends Problem {
	Integer numberOfI_;
	 ...
	 */
	public DTLZ5IM(String solutionType) throws ClassNotFoundException {
// this (solutionType, numberOfVariables, numberOfObjectives, numberOfI);//
//	this(solutionType, 19, 10, 3);//10 objectives 
//	this(solutionType, 19, 10, 4);//10 objectives 
//	this(solutionType, 19, 10, 5);//10 objectives 
//	this(solutionType, 19, 10, 6);//10 objectives 
//	this(solutionType, 19, 10, 7);//10 objectives 
//    this(solutionType, 19, 10, 8);//10 objectives 
	 ...
	 * @param solutionType       The solution type must "Real" or "BinaryReal".
	 */
	public DTLZ5IM(String solutionType,
